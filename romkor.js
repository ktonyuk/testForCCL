...
syl = syl.replace(/쉬/g, "swi");
syl = syl.replace(/쉭/g, "swik");
syl = syl.replace(/쉰/g, "swin");
syl = syl.replace(/쉴/g, "swil");
syl = syl.replace(/쉼/g, "swim");
syl = syl.replace(/쉽/g, "swib");
syl = syl.replace(/쉿/g, "swis");
syl = syl.replace(/슁/g, "swing");
...
syl = syl.replace(/시/g, "si");
syl = syl.replace(/식/g, "sik");
syl = syl.replace(/신/g, "sin");
syl = syl.replace(/싣/g, "sid");
syl = syl.replace(/실/g, "sil");
syl = syl.replace(/싫/g, "silh");
syl = syl.replace(/심/g, "sim");
syl = syl.replace(/십/g, "sib");
syl = syl.replace(/싯/g, "sis");
syl = syl.replace(/싱/g, "sing");
syl = syl.replace(/싶/g, "sip");
...
// ㅈ, ㄷ, ㅌ, ㅊ+ ㅎ followed by y or i, makes ㅊ together 

var find = syl.match(/[jdt]h[yi]/g);
if (find !== null) {
	console.log(find);
	for (i = 0; i < find.length; i++) {
   		syl = syl.replace(find[i], find[i].replace(/[jdt]h/g, "ch"));
	}
}
